class DropBoxController {
    ...
    constructor(){
        ...
        this.timeleft = this.snackModal.querySelector('.timeleft');
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDJFsr9fpAt7uP6oSpr5enEuX3XmIp-NKg",
            authDomain: "dropbox-clone-4d57d.firebaseapp.com",
            databaseURL: "https://dropbox-clone-4d57d.firebaseio.com",
            projectId: "dropbox-clone-4d57d",
            storageBucket: "dropbox-clone-4d57d.appspot.com",
            messagingSenderId: "554748663133",
            appId: "1:554748663133:web:c94790a5822862b0dd84b4",
            measurementId: "G-52411XXC8R"
          };
    ...
    initEvents(){
        ...
        this.listFiles.addEventListener('onselectionchange', e=>{
    ...
    uploadProgress(event, file){
        ...
        this.timeleft.innerHTML = this.formatTime(timeleft);
